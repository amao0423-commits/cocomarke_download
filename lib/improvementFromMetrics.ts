...
export function buildImprovementFromMetrics(input: MetricsInput): string[] {
  ...
  messages.push(
    'ハッシュタグは現在、1投稿あたり最大5個までです。かつてのように数を増やしてもリーチは伸びず、役割は投稿内容の分類と検索の手がかりに限られます。そのため、関連性の高い3〜5個に厳選し、大量付けはやめてください。ハッシュタグに頼るより、キャプション本文に検索されたいキーワードを自然に盛り込む「キーワード検索対策」のほうが、現在は発見されやすさに直結します。'
  );
