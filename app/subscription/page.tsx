...
const PLANS = [
  ...
  { name: "人気・おすすめ投稿表示プラン", price: 19800, desc: "投稿の初速エンゲージメントを高め、おすすめ・発見タブへの掲載確率を劇的に向上。新規リーチを最大化。" },
  { name: "セットプラン", price: 24980, desc: "「いいね代行プラン」と「人気・おすすめ投稿表示プラン」のセット。両方を同時運用し、相乗効果で成果を最大化。" },
  { name: "アカウント上位表示プラン", price: 29800, desc: "狙ったキーワード検索でアカウントが上位表示されるよう最適化。特定キーワードの独占を目指す。" },
  { name: "プレミアムプラン", price: 49800, desc: "ご要望や他SNSへのエンゲージメント増加など、ご相談内容に応じて、あなたに合ったプランをご提案・セレクトします。" },
];
...
const jsonLd = {
  ...
  "@graph": [
    ...
    },
    {
      ...
      description: "月額固定でインスタ運用をまるごとお任せできるサブスク。いいね代行・おすすめ・発見タブ最適化・アカウント上位表示・LINE相談まで対応。契約縛りなし・解約自由。",
