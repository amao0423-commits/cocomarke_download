...
export const metadata: Metadata = {
  ...
  description:
    "美容室・サロン専門のインスタ運用代行サブスク。おすすめ・発見タブ最適化とエリア×メニューのハッシュタグ攻略で、新規のお客様に見つけてもらい来店につなげます。月額固定・解約自由。髪質改善・縮毛矯正・ハイトーンカラーの集客実績多数。無料相談受付中。",
  alternates: {
  ...
  openGraph: {
    ...
    description:
      "おすすめ・発見タブ最適化とメニュー別ハッシュタグ攻略で、サロンを探しているお客様に見つけてもらえる美容室へ。月額固定・解約自由。",
    ...
    <>
      ...
      <main className="mx-auto max-w-3xl px-4 py-12 sm:py-16">
        ...
        <section className="text-center">
          <p className="text-sm font-medium text-emerald-700">美容室・サロン向け｜サブスク型インスタ運用代行</p>
          <h1 className="mt-3 text-3xl font-bold leading-snug sm:text-4xl">
            美容室のインスタ集客を、月額固定でまるごと代行
          </h1>
          <p className="mt-5 text-base leading-relaxed text-gray-600">
            「投稿しても新規予約につながらない」を、JEMIAが変えます。おすすめ・発見タブ最適化とメニュー別ハッシュタグ攻略で、サロンを探しているお客様に見つけてもらえる美容室へ。
          </p>
        ...
        <section className="mt-20 rounded-2xl bg-gray-50 px-6 py-12 text-center">
          ...
          <p className="mt-4 leading-relaxed text-gray-600">
            美容室のインスタ集客でお悩みなら、まずはフォームからお気軽にどうぞ。3日以内に確認後、ご入力いただいたメールアドレス宛にご連絡します。
          </p>
          <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row">
            <a href="/subscription#contact" className="rounded-lg bg-emerald-600 px-6 py-3 text-white">
              無料で相談する →
