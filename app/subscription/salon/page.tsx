...
export const metadata: Metadata = {
  title: "美容室のインスタ集客を月額固定で代行｜新規客を増やすSNS運用｜JEMIA",
  description:
    "美容室・サロン専門のインスタ運用代行サブスク。発見タブ最適化とエリア×メニューのハッシュタグ攻略で、新規のお客様に見つけてもらい来店につなげます。月額固定・解約自由。髪質改善・縮毛矯正・ハイトーンカラーの集客実績多数。無料相談受付中。",
  alternates: {
    canonical: "https://www.cocomake-guide.com/subscription/salon",
  },
  openGraph: {
    title: "美容室のインスタ集客を月額固定で代行｜JEMIA",
    description:
      "発見タブ最適化とメニュー別ハッシュタグ攻略で、サロンを探しているお客様に見つけてもらえる美容室へ。月額固定・解約自由。",
    url: "https://www.cocomake-guide.com/subscription/salon",
    type: "website",
  },
};
...
const faqItems = [
  ...
  {
    q: "得意メニューの強みは打ち出せますか？",
    a: "はい。髪質改善・縮毛矯正・ハイトーンカラーなど、サロンの得意分野に合わせたキーワード設計と投稿戦略を組み立て、その悩みを持つお客様に届くよう運用します。",
  },
  {
    q: "美容室でもアカウント凍結のリスクはありませんか？",
    a: "アカウント保護設定のもと、1日あたりの上限を守って安全に運用します。専任担当が業種ごとの適切な運用を行うため、リスクを最小限に抑えています。",
  },
  {
    q: "更新の手間はかかりますか？",
    a: "初期設定から日々の運用まで専任担当が代行します。オーナー様・スタイリスト様の作業は基本的に不要で、施術と接客に集中いただけます。",
  },
  {
    q: "個人サロンや面貸しでも利用できますか？",
    a: "はい。個人サロンから多店舗展開のサロンまで対応しています。月額固定・解約自由なので、小規模でも予算を読みながら始められます。",
  },
];
    ...
    },
    {
      ...
      itemListElement: [
        ...
        },
        {
          ...
          position: 3,
          name: "美容室向け",
          item: "https://www.cocomake-guide.com/subscription/salon",
        },
      ],
    },
  ],
    ...
    <>
      ...
      <main className="mx-auto max-w-3xl px-4 py-12 sm:py-16">
        ...
        <section className="text-center">
          <p className="text-sm font-medium text-emerald-700">美容室・サロン向け｜インスタ運用サブスク</p>
          <h1 className="mt-3 text-3xl font-bold leading-snug sm:text-4xl">
            美容室のインスタ集客を、月額固定でまるごと代行
          </h1>
          <p className="mt-5 text-base leading-relaxed text-gray-600">
            「投稿しても新規予約につながらない」を、JEMIAが変えます。発見タブ最適化とメニュー別ハッシュタグ攻略で、サロンを探しているお客様に見つけてもらえる美容室へ。
          </p>
        ...
        <section className="mt-20">
          <h2 className="text-2xl font-bold">美容室のインスタ、こんな悩みありませんか？</h2>
          <ul className="mt-6 space-y-3 text-gray-700">
            <li>スタイル写真を載せても、フォロワー以外に届かず新規予約につながらない</li>
            <li>施術や接客で手一杯で、投稿やストーリーを更新する時間がない</li>
            <li>「渋谷 美容室」などで検索されても、近隣の人気サロンに埋もれてしまう</li>
            <li>得意メニュー（髪質改善・縮毛矯正・ハイトーンなど）の強みが伝わっていない</li>
            <li>スタッフに任せてみたが、続かず更新が止まってしまった</li>
          </ul>
          <p className="mt-6 leading-relaxed text-gray-600">
            美容室のインスタ運用でつまずく原因は、技術力ではなく「強みを見込み客に届ける仕組み」がないことです。
          </p>
        </section>

        {/* 理由 */}
        <section className="mt-20">
          <h2 className="text-2xl font-bold">JEMIAが美容室の集客を変える3つの理由</h2>
          <div className="mt-8 space-y-8">
            ...
            <div>
              ...
              <p className="mt-2 leading-relaxed text-gray-600">
                「渋谷美容室」「髪質改善」「ハイトーンカラー」「縮毛矯正」など、地域と得意メニューのキーワードで上位表示を狙います。「自分の悩みに合うサロンを探している人」に、ぴったりのタイミングで強みを見せられます。
              </p>
            </div>
            <div>
              <h3 className="text-lg font-semibold">忙しいオーナー・スタイリストに代わって専任担当が運用</h3>
              <p className="mt-2 leading-relaxed text-gray-600">
        ...
        {/* 実績 */}
        <section className="mt-20">
          <h2 className="text-2xl font-bold">美容室・サロンアカウントでの実績</h2>
          <p className="mt-4 leading-relaxed text-gray-600">
            JEMIAは美容室・サロンをはじめ3000以上のアカウントを運用してきました。エリア×メニューのキーワードで多数の上位表示実績があります。
          </p>
        ...
        {/* FAQ */}
        <section className="mt-20">
          <h2 className="text-2xl font-bold">美容室のインスタ集客でよくある質問</h2>
        ...
        <section className="mt-20 rounded-2xl bg-gray-50 px-6 py-12 text-center">
          ...
          <p className="mt-4 leading-relaxed text-gray-600">
            美容室のインスタ集客でお悩みなら、まずはフォームからお気軽にどうぞ。翌営業日以内に返信します。
          </p>
          <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row">
            <a href="/subscription#contact" className="rounded-lg bg-emerald-600 px-6 py-3 text-white">
              無料で相談する →
